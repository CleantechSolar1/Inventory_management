...
<div class="container mt-4">
    ...
    <form method="POST" action="{{ url_for('main.add_expense') }}">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="occurrence_mode">Occurrence Mode</label>
                    <select class="form-control" id="occurrence_mode" name="occurrence_mode" required>
                        <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Quarterly">Quarterly</option>
                        <option value="Half-yearly">Half-yearly</option>
                        <option value="Yearly">Yearly</option>
                        <option value="Yearly">One-Time</option>
                    </select>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="amount_gst">Amount with GST</label>
                    <input type="number" step="0.01" class="form-control" id="amount_gst" name="amount_gst" required>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
